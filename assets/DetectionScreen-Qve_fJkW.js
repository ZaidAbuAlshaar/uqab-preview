...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},kp=(e,t)=>new Do(e,t)}),Po,Hi,Uo,qo,Lo,Wo,Ve,Tp,Ip,vt=P(()=>{te(),ie(),Se(),ae(),Po=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Hi=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Uo=(e,t)=>R.sortBasedOnPerm(e,Hi(e.length,t)),qo=(e,t,r,i)=>{let a=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)a+=`a[${e[s]}]=i[${s}];`;return a+="return a;}"},Lo=(e,t)=>{let r=[],i=[];for(let a=0;a<e.length;++a)e[a]!==1&&r.push(e[a]),e[t[a]]!==1&&i.push(t[a]);return{newShape:r,newPerm:i}},Wo=(e,t)=>{let r=0;for(let i=0;i<e.length;++i)if(t[e[i]]!==1){if(e[i]<r)return!1;r=e[i]}return!0},Ve=(e,t)=>{let r=e.dataType,i=e.dims.length,a=Hi(i,t),s=Uo(e.dims,a),n=e.dims,u=s,l=i<2||Wo(a,e.dims),p;if(l)return p=_=>{let b=M("input",r,n,4),k=Q("output",r,u,4);return`
  ${_.registerUniform("output_size","u32").declareVariables(b,k)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=R.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:p};let{newShape:h,newPerm:f}=Lo(e.dims,a),g=R.areEqual(f,[2,3,1]),y=R.areEqual(f,[3,1,2]);if(h.length===2||g||y){n=g?[h[0],h[1]*h[2]]:y?[h[0]*h[1],h[2]]:h,u=[n[1],n[0]];let _=16;return p=b=>{let k=M("a",r,n.length),v=Q("output",r,u.length);return`
  ...
  ${_.mainStart()}
    ...
    ${k.setByOffset("global_idx",b.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let _=R.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...ee(n,u)]}},getShaderSource:p}},Tp=(e,t)=>{Po(e.inputs,t.perm),e.compute(Ve(e.inputs[0],t.perm))},Ip=e=>fe({perm:e.perm})}),Vo,Go,Ho,Fo,jo,Ko,Zo,Xo,Qo,Yo,Ke,Ep,zp,Cp,Ap,Op,Rp,Bp,Np,Mp,Dp,c0=P(()=>{te(),ie(),ae(),Ya(),vt(),Vo={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},Go={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},Ho={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},Fo={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},jo=(e,t)=>{let r=[];for(let i=t-e;i<t;++i)r.push(i);return r},Ko=(e,t)=>{let r=[],i=e.length;for(let s=0;s<i;s++)t.indexOf(s)===-1&&r.push(e[s]);let a=t.map(s=>e[s]);return[r,a]},Zo=(e,t)=>{let r=e.length+t.length,i=[],a=0;for(let s=0;s<r;s++)t.indexOf(s)===-1?i.push(e[a++]):i.push(1);return i},Xo=(e,t)=>{for(let r=0;r<e.length;++r)if(e[e.length-r-1]!==t-1-r)return!1;return!0},Qo=(e,t)=>{let r=[];if(!Xo(e,t)){for(let i=0;i<t;++i)e.indexOf(i)===-1&&r.push(i);e.forEach(i=>r.push(i))}return r},Yo=(e,t,r,i,a,s,n)=>{let u=r[0].dims,l=R.size(s),p=R.size(n),h=M("_A",r[0].dataType,u),f=Q("output",a,s),g=64;l===1&&(g=256);let y=`
       ...
       `,_=b=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:l},programUniforms:[{type:12,data:p}]})}},Ke=(e,t,r,i)=>{let a=e.inputs.length===1?r:Ia(e.inputs,r),s=a.axes;s.length===0&&!a.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((y,_)=>_));let n=R.normalizeAxes(s,e.inputs[0].dims.length),u=n,l=e.inputs[0],p=Qo(u,e.inputs[0].dims.length);p.length>0&&(l=e.compute(Ve(e.inputs[0],p),{inputs:[0],outputs:[-1]})[0],u=jo(u.length,l.dims.length));let[h,f]=Ko(l.dims,u),g=h;a.keepDims&&(g=Zo(h,n)),e.compute(Yo(t,a.cacheKey,[l],i,e.inputs[0].dataType,g,f),{inputs:[l]})},Ep=(e,t)=>{Ke(e,"ReduceMeanShared",t,"mean")},zp=(e,t)=>{Ke(e,"ReduceL1Shared",t,"l1")},Cp=(e,t)=>{Ke(e,"ReduceL2Shared",t,"l2")},Ap=(e,t)=>{Ke(e,"ReduceLogSumExpShared",t,"logSumExp")},Op=(e,t)=>{Ke(e,"ReduceMaxShared",t,"max")},Rp=(e,t)=>{Ke(e,"ReduceMinShared",t,"min")},Bp=(e,t)=>{Ke(e,"ReduceProdShared",t,"prod")},Np=(e,t)=>{Ke(e,"ReduceSumShared",t,"sum")},Mp=(e,t)=>{Ke(e,"ReduceSumSquareShared",t,"sumSquare")},Dp=(e,t)=>{Ke(e,"ReduceLogSumShared",t,"logSum")}}),Ze,Jo,Jr,Ia,Xe,eu,tu,ru,iu,au,nu,su,ou,uu,lu,Qe,Pp,Up,qp,Lp,Wp,Vp,Gp,Hp,Fp,jp,Ya=P(()=>{te(),ie(),Se(),ae(),c0(),Ze=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Jo=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Jr=(e,t,r,i,a,s,n=!1,u=!1)=>{let l=[],p=r[0].dims,h=p.length,f=R.normalizeAxes(a,h),g=!u&&f.length===0;p.forEach((b,k)=>{g||f.indexOf(k)>=0?n&&l.push(1):l.push(b)});let y=l.length,_=R.size(l);return{name:e,shaderCache:t,getShaderSource:b=>{let k=[],v=M("_A",r[0].dataType,h),$=Q("output",s,y),I=i(v,$,f),S=I[2];for(let E=0,C=0;E<h;E++)g||f.indexOf(E)>=0?(n&&C++,S=`for(var j${E}: u32 = 0; j${E} < ${p[E]}; j${E}++) {
...
var best_index : i32 = 0;`,`if (${i.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:u,programUniforms:p}),getShaderSource:h},{inputs:l,outputs:[-1,-1,-1]})},Xp=(e,t)=>{let r=du(e.inputs,t),[i,a,s]=fu(e,r);return _r(e,i,a,s,e.inputs[4],void 0,void 0,void 0,e.inputs[5],r)}}),mu,gu,yu,Qp,f0=P(()=>{Fe(),te(),ie(),Se(),ae(),mu=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let r=(i,a,s)=>{let n=a.length;if(n!==i.length)throw new Error(`${s}: num dimensions != ${n}`);a.forEach((u,l)=>{if(u!==i[l])throw new Error(`${s}: dim[${l}] do not match`)})};if(e[0].dims.length>1){let i=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);r(e[1].dims,i,"Invalid input scale"),r(e[2].dims,i,"Invalid input B"),r(e[3].dims,i,"Invalid input mean"),r(e[4].dims,i,"Invalid input var")}else r(e[1].dims,[1],"Invalid input scale"),r(e[2].dims,[1],"Invalid input B"),r(e[3].dims,[1],"Invalid input mean"),r(e[4].dims,[1],"Invalid input var")},gu=(e,t)=>{let{epsilon:r,spatial:i,format:a}=t,s=e[0].dims,n=i?xe(s[s.length-1]):1,u=a==="NHWC"&&s.length>1?n:1,l=R.size(s)/n,p=i,h=p?s.length:s,f=M("x",e[0].dataType,e[0].dims,n),g=M("scale",e[1].dataType,e[1].dims,u),y=M("bias",e[2].dataType,e[2].dims,u),_=M("inputMean",e[3].dataType,e[3].dims,u),b=M("inputVar",e[4].dataType,e[4].dims,u),k=Q("y",e[0].dataType,h,n),v=()=>{let I="";if(i)I=`let cOffset = ${s.length===1?"0u":a==="NHWC"?`outputIndices[${s.length-1}] / ${n}`:"outputIndices[1]"};`;else if(a==="NCHW")I=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${i}_${n}`,inputDependencies:p?["rank","type","type","type","type"]:void 0},getShaderSource:$,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:p?[{type:12,data:l},...ee(s)]:[{type:12,data:l}]})}},yu=e=>fe(e),Qp=(e,t)=>{let{inputs:r,outputCount:i}=e,a=yu({...t,outputCount:i});if(be.webgpu.validateInputContent&&mu(r,a),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(gu(r,a))}}),_u,bu,Yp,m0=P(()=>{ie(),ae(),_u=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},bu=e=>{let t=e[0].dims,r=e[0].dims[2],i=R.size(t)/4,a=e[0].dataType,s=M("input",a,t,4),n=M("bias",a,[r],4),u=M("residual",a,t,4),l=Q("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:p=>`
  ...
  }`}},Yp=e=>{_u(e.inputs),e.compute(bu(e.inputs))}}),wu,ce,Jp,ec,tc,rc,ic,ac,nc,sc,oc,$u,uc,lc,dc,pc,hr,cc,jr,hc,fc,mc,gc,yc,_c,bc,wc,$c,vc,xc,Sc,kc,Tc,Ic,Ec,ji,zc,za,Ca,Cc,Ac,Oc,vu,xu,Rc,en=P(()=>{te(),ie(),Se(),ae(),wu=(e,t,r,i,a,s,n)=>{let u=Math.ceil(t/4),l="";typeof a=="string"?l=`${a}(a)`:l=a("a");let p=M("inputData",r,[u],4),h=Q("outputData",i,[u],4),f=[{name:"vec_size",type:"u32"}];return n&&f.push(...n),`
  ...
  }`},ce=(e,t,r,i,a,s=e.dataType,n,u)=>{let l=[{type:12,data:Math.ceil(R.size(e.dims)/4)}];return n&&l.push(...n),{name:t,shaderCache:{hint:a,inputDependencies:["type"]},getShaderSource:p=>wu(p,R.size(e.dims),e.dataType,s,r,i,u),getRunData:p=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(R.size(p[0].dims)/64/4)},programUniforms:l})}},Jp=e=>{e.compute(ce(e.inputs[0],"Abs","abs"))},ec=e=>{e.compute(ce(e.inputs[0],"Acos","acos"))},tc=e=>{e.compute(ce(e.inputs[0],"Acosh","acosh"))},rc=e=>{e.compute(ce(e.inputs[0],"Asin","asin"))},ic=e=>{e.compute(ce(e.inputs[0],"Asinh","asinh"))},ac=e=>{e.compute(ce(e.inputs[0],"Atan","atan"))},nc=e=>{e.compute(ce(e.inputs[0],"Atanh","atanh"))},sc=e=>fe(e),oc=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(ce(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},$u=e=>{let t,r,i=e.length>=2&&e[1].data!==0,a=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=i?e[1].getFloat32Array()[0]:-34028234663852886e22,r=a?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=i?e[1].getUint16Array()[0]:64511,r=a?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return fe({min:t,max:r})},uc=(e,t)=>{let r=t||$u(e.inputs),i=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Clip",a=>`clamp(${a}, vec4<${i}>(uniforms.min), vec4<${i}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:i},{name:"max",type:i}]),{inputs:[0]})},lc=e=>{e.compute(ce(e.inputs[0],"Ceil","ceil"))},dc=e=>{e.compute(ce(e.inputs[0],"Cos","cos"))},pc=e=>{e.compute(ce(e.inputs[0],"Cosh","cosh"))},hr=e=>fe(e),cc=(e,t)=>{let r=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Elu",i=>`elu_vf32(${i})`,`
...
}`,hc=e=>{let t=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,jr(t)))},fc=e=>{e.compute(ce(e.inputs[0],"Exp","exp"))},mc=e=>{e.compute(ce(e.inputs[0],"Floor","floor"))},gc=e=>{let t=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,jr(t)))},yc=(e,t)=>{let r=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},_c=e=>{e.compute(ce(e.inputs[0],"Not",t=>`!${t}`))},bc=e=>{e.compute(ce(e.inputs[0],"Neg",t=>`-${t}`))},wc=e=>{e.compute(ce(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},$c=e=>{let t=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},vc=e=>{e.compute(ce(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},xc=e=>fe(e),Sc=(e,t)=>{let r=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},kc=e=>{e.compute(ce(e.inputs[0],"Sin","sin"))},Tc=e=>{e.compute(ce(e.inputs[0],"Sinh","sinh"))},Ic=e=>{e.compute(ce(e.inputs[0],"Sqrt","sqrt"))},Ec=e=>{e.compute(ce(e.inputs[0],"Tan","tan"))},ji=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,zc=e=>{e.compute(ce(e.inputs[0],"Tanh",ji))},za=(e="f32")=>`
...
`,Ca=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Cc=e=>{let t=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"FastGelu",Ca,za(t),void 0,e.inputs[0].dataType))},Ac=(e,t)=>{let r=Oe(e.inputs[0].dataType);return e.compute(ce(e.inputs[0],"ThresholdedRelu",i=>`select(vec4<${r}>(0.0), ${i}, ${i} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Oc=e=>{e.compute(ce(e.inputs[0],"Log","log"))},vu=(e,t)=>`
...
`,xu=e=>`quick_gelu_impl(${e})`,Rc=(e,t)=>{let r=Oe(e.inputs[0].dataType);e.compute(ce(e.inputs[0],"QuickGelu",xu,vu(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Su,ku,Bc,g0=P(()=>{ie(),ae(),en(),Su=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},ku=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=M("input",e[0].dataType,e[0].dims,4),i=M("bias",e[0].dataType,[e[0].dims[2]],4),a=Q("output",e[0].dataType,t,4),s=R.size(t)/4,n=Ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},Iu=(e,t,r,i,a,s,n=r.dataType)=>{let u=r.dims.map(Number),l=i.dims.map(Number),p=!R.areEqual(u,l),h=u,f=R.size(u),g=!1,y=!1,_=[p];if(p){let b=jt.calcShape(u,l,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");h=b.slice(),f=R.size(h);let k=R.size(u)===1,v=R.size(l)===1,$=u.length>0&&u[u.length-1]%4===0,I=l.length>0&&l[l.length-1]%4===0;_.push(k),_.push(v),_.push($),_.push(I);let S=1;for(let E=1;E<h.length;E++){let C=u[u.length-E],A=l[l.length-E];if(C===A)S*=C;else break}S%4===0?(y=!0,g=!0):(k||v||$||I)&&(g=!0)}else g=!0;return _.push(g),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>Tu(b,u,l,h,g,p,y,a,r.dataType,i.dataType,n,s),getRunData:()=>({outputs:[{dims:h,dataType:n}],dispatchGroup:{x:Math.ceil(f/64/4)},programUniforms:[{type:12,data:Math.ceil(R.size(h)/4)},...ee(u,l,h)]})}},Ye=(e,t,r,i,a,s)=>{e.compute(Iu(t,a??"",e.inputs[0],e.inputs[1],r,i,s))},Nc=e=>{Ye(e,"Add",(t,r)=>`${t}+${r}`)},Mc=e=>{Ye(e,"Div",(t,r)=>`${t}/${r}`)},Dc=e=>{Ye(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Pc=e=>{Ye(e,"Mul",(t,r)=>`${t}*${r}`)},Uc=e=>{let t=M("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Ye(e,"Pow",{scalar:(r,i)=>`pow_custom(${r},${i})`,vector:(r,i)=>`pow_vector_custom(${r},${i})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},qc=e=>{Ye(e,"Sub",(t,r)=>`${t}-${r}`)},Lc=e=>{Ye(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},Wc=e=>{Ye(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Vc=e=>{Ye(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},Gc=e=>{Ye(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),Eu,zu,Cu,Au,Hc,Fc,_0=P(()=>{te(),ie(),Se(),ae(),Eu=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,i=e[r],a=i.dataType,s=i.dims.length;e.forEach((n,u)=>{if(u!==r){if(n.dataType!==a)throw new Error("input tensors should be one type");if(n.dims.length!==s)throw new Error("input tensors should have the same shape");n.dims.forEach((l,p)=>{if(p!==t&&l!==i.dims[p])throw new Error("non concat dimensions must match")})}})},zu=(e,t)=>`
...
`)},Au=(e,t,r,i)=>{let a=R.size(r),s=new Array(e.length),n=new Array(e.length),u=0,l=[],p=[],h=[{type:12,data:a}];for(let b=0;b<e.length;++b)u+=e[b].dims[t],s[b]=u,p.push(e[b].dims.length),n[b]=M(`input${b}`,i,p[b]),l.push("rank"),h.push({type:12,data:s[b]});for(let b=0;b<e.length;++b)h.push(...ee(e[b].dims));h.push(...ee(r));let f=Q("output",i,r.length),g=f.indicesGet("indices",t),y=Array.from(Array(s.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
  ...
  ${b.mainStart()}
    ...
    ${Cu(n,f)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:r,dataType:i}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:h}),getShaderSource:_}},Hc=(e,t)=>{let r=e.inputs,i=r[0].dims,a=R.normalizeAxis(t.axis,i.length);Eu(r,a);let s=i.slice();s[a]=r.reduce((u,l)=>u+(l.dims.length>a?l.dims[a]:0),0);let n=r.filter(u=>R.size(u.dims)>0);e.compute(Au(n,a,s,r[0].dataType),{inputs:n})},Fc=e=>fe({axis:e.axis})}),Mt,Dt,Pt,tn,qt=P(()=>{te(),ie(),Mt=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Dt=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Pt=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},tn=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[r,i]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:r,beta:i}}else if(t==="Clip"){let[r,i]=(e==null?void 0:e.activation_params)||[_p,bp];return{activation:t,clipMax:i,clipMin:r}}else if(t==="LeakyRelu"){let[r]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:r}}return{activation:t}}}),Ce,jc,rn=P(()=>{Ce=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},jc=e=>`
...
`}),mr,an,nn=P(()=>{te(),ie(),ae(),qt(),mr=(e,t,r,i,a)=>{let s=i-r;return`
...
`},an=(e,t,r,i,a=!1,s)=>{let n=e[0].dims,u=e[1].dims,l=n[n.length-2],p=u[u.length-1],h=n[n.length-1],f=xe(p),g=xe(h),y=xe(l),_=R.size(r)/f/y,b=e.length>2,k=i?i.slice(0,-2):r.slice(0,-2),v=[R.size(k),l,p],$=[{type:12,data:_},{type:12,data:l},{type:12,data:p},{type:12,data:h}];Dt(t,$),$.push(...ee(k,n,u)),b&&$.push(...ee(e[2].dims)),$.push(...ee(v));let I=S=>{let E=Qa("batch_dims",e[0].dataType,k.length),C=M("a",e[0].dataType,n.length,g),A=M("b",e[1].dataType,u.length,f),w=Q("output",e[0].dataType,v.length,f),O=Ee(w.type.tensor),D=Mt(t,w.type.value,O),L=[C,A],G="";if(b){let H=a?f:1;L.push(M("bias",e[2].dataType,e[2].dims.length,H)),G=`${a?`value += bias[col / ${H}];`:`value += ${w.type.value}(bias[row + i]);`}`}let j=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Pt(t,j);let B=()=>{let H=`var a_data: ${C.type.value};`;for(let Z=0;Z<g;Z++)H+=`
...
`}return H};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${g};${y};${a}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:$}),getShaderSource:I}}}),Ou,Ru,Aa,Ki,Bu,Oa,Nu,ei,sn=P(()=>{te(),ie(),ae(),qt(),nn(),rn(),Ou=(e,t)=>e?`
        ...
        }`,Aa=(e,t,r="f32",i,a=!1,s=32,n=!1,u=32)=>{let l=t[1]*e[1],p=t[0]*e[0],h=a?l:s,f=a?s:l,g=h/t[0],y=s/t[1];if(!((a&&g===4&&e[1]===4||!a&&(g===3||g===4))&&h%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${a} is true, innerElementSize ${g} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Bu=e=>e?"let ACached = mm_Asub[k][tileRow + innerRow];":"let ACached = mm_Asub[tileRow + innerRow][k];",Oa=(e,t,r="f32",i,a=!1,s=32,n=!1,u=32,l=!1)=>{let p=e[1]*t[1],h=e[0]*t[0],f=a?p:s,g=a?s:p;if(!(g%t[1]===0&&f%t[0]===0&&s%t[1]===0))throw new Error(`tileAHight ${g} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${f} must be divisible by workgroupSize[0]${t[0]}, tileInner ${s} must be divisible by workgroupSize[1]${t[1]}`);let y=g/t[1],_=f/t[0],b=s/t[1],k=l?`
    let localRow = i32(localId.y);
...
`},Nu=(e,t,r,i,a=!1)=>{let[s,n,u,l]=i,p=Ee(i[0].type.tensor);return`
  ...
  ${b?Aa(k,v,Z,H):Oa(k,v,Z,H)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${V}>`:V}) {
        ...
        ${ue}
        ${Mu(p,O,D,L,n,t,G[0],G[1],G[2],V)}
        ${b?Aa(I,$,V,void 0,!p,w):Oa(I,$,V,void 0,!p,w,!1,void 0,u)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${E};${b};${O};${D};${L};${C};${A};${w}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:l?l(r):r,dataType:e[0].dataType}],dispatchGroup:{x:S[0],y:S[1],z:S[2]},programUniforms:j}),getShaderSource:H}}}),Du,Zi,nr,Pu,Xi,Uu,Xc,Qc,$0=P(()=>{te(),pt(),ie(),ae(),qt(),rn(),Du=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Zi=e=>typeof e=="number"?[e,e,e]:e,nr=(e,t)=>t<=1?e:e+(e-1)*(t-1),Pu=(e,t,r,i=1)=>{let a=nr(t,i);return Math.floor((e[0]*(r-1)-r+a)/2)},Xi=(e,t,r,i,a)=>{a==null&&(a=Pu(e,t[0],i[0]));let s=[0,0,0,r];for(let n=0;n<3;n++)e[n]+2*a>=t[n]&&(s[n]=Math.trunc((e[n]-t[n]+2*a)/i[n]+1));return s},Uu=(e,t,r,i,a,s,n,u,l,p)=>{let h,f,g,y;if(e==="VALID"&&(e=0),typeof e=="number"){h={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=Xi([t,r,i,1],[u,l,p],1,[a,s,n],e);f=_[0],g=_[1],y=_[2]}else if(Array.isArray(e)){if(!e.every((b,k,v)=>b===v[0]))throw Error(`Unsupported padding parameter: ${e}`);h={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=Xi([t,r,i,1],[u,l,p],1,[a,s,n],e[0]);f=_[0],g=_[1],y=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/a),g=Math.ceil(r/s),y=Math.ceil(i/n);let _=(f-1)*a+u-t,b=(g-1)*s+l-r,k=(y-1)*n+p-i,v=Math.floor(_/2),$=_-v,I=Math.floor(b/2),S=b-I,E=Math.floor(k/2),C=k-E;h={top:I,bottom:S,left:E,right:C,front:v,back:$}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:h,outDepth:f,outHeight:g,outWidth:y}},Xc=(e,t,r,i,a,s=!1,n="channelsLast")=>{let u,l,p,h,f;if(n==="channelsLast")[u,l,p,h,f]=e;else if(n==="channelsFirst")[u,f,l,p,h]=e;else throw new Error(`Unknown dataFormat ${n}`);let[g,,y,_,b]=t,[k,v,$]=Zi(r),[I,S,E]=Zi(i),C=nr(y,I),A=nr(_,S),w=nr(b,E),{padInfo:O,outDepth:D,outHeight:L,outWidth:G}=Uu(a,l,p,h,k,v,$,C,A,w),j=s?g*f:g,B=[0,0,0,0,0];return n==="channelsFirst"?B=[u,j,D,L,G]:n==="channelsLast"&&(B=[u,D,L,G,j]),{batchSize:u,dataFormat:n,inDepth:l,inHeight:p,inWidth:h,inChannels:f,outDepth:D,outHeight:L,outWidth:G,outChannels:j,padInfo:O,strideDepth:k,strideHeight:v,strideWidth:$,filterDepth:y,filterHeight:_,filterWidth:b,effectiveFilterDepth:C,effectiveFilterHeight:A,effectiveFilterWidth:w,dilationDepth:I,dilationHeight:S,dilationWidth:E,inShape:e,outShape:B,filterShape:t}},Qc=(e,t,r,i,a,s)=>{let n=s==="channelsLast";n?e[0].dims[3]:e[0].dims[1];let u=[64,1,1],l={x:r.map((k,v)=>v)},p=[Math.ceil(Du(l.x.map(k=>r[k]))/u[0]),1,1];de("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${p}`);let h=1,f=R.size(r),g=[{type:12,data:f},{type:12,data:i},{type:12,data:a},{type:12,data:t.strides},{type:12,data:t.dilations}];Dt(t,g),g.push(...ee(e[0].dims,e[1].dims));let y=["rank","rank"],_=e.length===3;_&&(g.push(...ee(e[2].dims)),y.push("rank")),g.push(...ee(r));let b=k=>{let v=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:a.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];Pt(t,v);let $=1,I=Ee(e[0].dataType),S=M("x",e[0].dataType,e[0].dims.length,h),E=M("W",e[1].dataType,e[1].dims.length,$),C=[S,E],A=Q("result",e[0].dataType,r.length,$),w="";if(_){let L=M("bias",e[2].dataType,e[2].dims.length,$);C.push(L),w+=`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:y}),getShaderSource:b}},Jc=(e,t,r,i)=>{let a=e.length>2,s=xe(r[3]),n=xe(r[2]),u=R.size(r)/s/n,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],p=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],h=[r[0],r[1],r[2],r[3]/s],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Dt(t,f),f.push(...ee(l,p,h));let g=(n-1)*t.strides[1]+p[1],y=_=>{let b=Q("output",e[0].dataType,h.length,s),k=Ee(b.type.tensor),v=Mt(t,b.type.value,k),$=M("x",e[0].dataType,l.length,s),I=M("w",e[1].dataType,p.length,s),S=[$,I];a&&S.push(M("b",e[2].dataType,e[2].dims,s));let E=a?"value += b[output_channel];":"",C=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Pt(t,C),`
  ...
  ${_.mainStart()}
    ...
    ${F}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${h}${b}${_}${f}${y}`,inputDependencies:$},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:r?r(a):a,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:O}}}),Gu,Hu,Fu,Yi,th,ju,Ji,Ku,rh,k0=P(()=>{S0(),qt(),vt(),Gu=(e,t,r,i,a,s)=>(e-1)*t+r+(i-1)*a+1-s,Hu=(e,t,r,i,a)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[i]=s,r[a]=e-s):t==="SAME_LOWER"&&(r[i]=e-s,r[a]=s)},Fu=(e,t,r,i,a,s,n,u,l,p)=>{let h=e.length-2,f=p.length===0;l.length<h&&l.push(...Array(h-l.length).fill(0));let g=e[0],y=t[u?3:1]*a;for(let _=0,b=e.length-h-(u?1:0);_<h;++_,++b){let k=e[b],v=f?k*n[_]:p[_],$=Gu(k,n[_],s[_],t[b],r[_],v);Hu($,i,s,_,_+h),f&&p.push(n[_]*(k-1)+l[_]+(t[b]-1)*r[_]+1-s[_]-s[_+h])}p.splice(0,0,g),p.splice(u?3:1,0,y)},Yi=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((f,g)=>f*g,1)===0){r.length=0;for(let f=2;f<t[1].dims.length;++f)r.push(t[1].dims[f])}let i=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(i?3:1,0,t[1].dims[1]);let a=e.pads.slice(),s=e.outputShape.slice(),n=e.outputPadding.slice(),u=t[0].dims,l=e.dilations.slice();if(l.reduce((f,g)=>f+g,0)===0){let f=t[0].dims.length-2;l=new Array(f).fill(1)}let p=e.strides.slice();if(p.reduce((f,g)=>f+g,0)===0){let f=t[0].dims.length-2;p=new Array(f).fill(1)}Fu(u,r,l,e.autoPad,e.group,a,p,i,n,s);let h=Object.assign({},e);return Object.assign(h,{kernelShape:r,pads:a,outputPadding:n,outputShape:s,dilations:l,strides:p}),h},th=e=>{let t=tn(e),r=e.format,i=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],a=e.dilations,s=e.group??1,n=e.kernelShape,u=e.pads,l=e.strides,p=e.wIsConst(),h=e.outputPadding,f=e.outputShape;return{autoPad:i,format:r,dilations:a,group:s,kernelShape:n,outputPadding:h,outputShape:f,pads:u,strides:l,wIsConst:p,...t,cacheKey:`${e.format};${t.activation};`}},ju=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],i=e[1].dims[0];if(r!==i)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let a=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==a))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((n,u)=>n+u,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((n,u)=>n+u,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((n,u)=>n+u,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((n,u)=>n+u,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Ji=(e,t,r,i)=>{let a=e.kernelCustomData.wT??e.compute(Ve(t[1],[2,3,0,1]),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=a);let s=[t[0],a];t.length===3&&s.push(t[2]),e.compute(eh(s,r,i),{inputs:s})},Ku=(e,t)=>{let r=t.format==="NHWC",i=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&i.push(e.inputs[2]);let a=t.kernelShape;(a.length===0||a[0]===0)&&(a=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let n=t.strides;(n.length===0||n[0]===0)&&(n=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],n=[1].concat(n),s=[1].concat(s),a=[1].concat(a);let l=t.outputPadding;l=[0].concat(l);let p=Yi({...t,pads:u,strides:n,dilations:s,kernelShape:a,outputPadding:l},i);Ji(e,i,p,h=>r?[h[0],h[2],h[3]]:[h[0],h[1],h[3]])},rh=(e,t)=>{if(ju(e.inputs,t),e.inputs[0].dims.length===3)Ku(e,t);else{let r=Yi(t,e.inputs);Ji(e,e.inputs,r)}}}),Zu,ih,ah,T0=P(()=>{te(),ie(),Se(),ae(),Zu=(e,t,r,i)=>{let a=R.size(t),s=t.length,n=M("input",e,s),u=Q("output",e,s),l=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),p=R.normalizeAxis(l,s),h=f=>{let g=` i32(${n.indicesGet("inputIndices","uniforms.axis")}) `,y=Y("uniforms.input_shape","uniforms.axis",s),_=i.reverse?g+(i.exclusive?" + 1":""):"0",b=i.reverse?y:g+(i.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:i.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},{type:12,data:p},...ee(t,t)]}),getShaderSource:h}},ih=(e,t)=>{let r=e.inputs[0].dims,i=e.inputs[0].dataType,a=e.inputs[1];e.compute(Zu(i,r,a,t),{inputs:[0]})},ah=e=>{let t=e.exclusive===1,r=e.reverse===1;return fe({exclusive:t,reverse:r})}}),Xu,Qu,Yu,nh,sh,I0=P(()=>{te(),ie(),Se(),ae(),Xu=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Qu=(e,t,r,i)=>{let a=[];a.push(`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)a.push(r.indicesSet("a",e[s],`i[${s}]`));return a.push("return a;}"),a.join(`
`)},Yu=(e,t)=>{let r,i,a,s,n,u,l=t.format==="NHWC",p=t.blocksize,h=t.mode==="DCR";l?([r,i,a,s]=e.dims,n=h?[r,i,a,p,p,s/p**2]:[r,i,a,s/p**2,p,p],u=h?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,i,a,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],n=h?[r,p,p,s/p**2,i,a]:[r,s/p**2,p,p,i,a],u=h?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let f=e.reshape(n),g=f.dims.length,y=e.dataType,_=M("a",y,g),b=Q("output",y,g),k=v=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:v=>{let $=l?[r,i*p,a*p,s/p**2]:[r,s/p**2,i*p,a*p],I=R.size($),S=f.dims,E=R.sortBasedOnPerm(S,u);return{outputs:[{dims:$,dataType:v[0].dataType}],dispatchGroup:{x:Math.ceil(I/64)},programUniforms:[{type:12,data:I},...ee(S,E)]}},getShaderSource:k}},nh=(e,t)=>{Xu(e.inputs),e.compute(Yu(e.inputs[0],t))},sh=e=>fe({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Lr,sr,ea,Ju,el,tl,rl,ta,il,oh,uh,E0=P(()=>{te(),ie(),Se(),ae(),Lr="[a-zA-Z]|\\.\\.\\.",sr="("+Lr+")+",ea="^"+sr+"$",Ju="("+sr+",)*"+sr,el="^"+Ju+"$",tl=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let r=this.symbolToIndices.get(e);r===void 0?r=[t]:r.push(t),this.symbolToIndices.set(e,r)}},rl=class{constructor(e,t){var a;this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[r,i]=t.includes("->")?t.split("->",2):[t,""];if(!r.match(RegExp(el)))throw new Error("Invalid LHS term");if(r.split(",").forEach((s,n)=>{let u=e[n].dims.slice();if(!s.match(RegExp(ea)))throw new Error("Invalid LHS term");let l=this.processTerm(s,!0,u,n);this.lhs.push(l)}),i==="")i+=[...this.symbolToInfo.entries()].filter(([s,n])=>n.count===1||s==="...").map(([s])=>s).join("");else if(!i.match(RegExp(sr)))throw new Error("Invalid RHS");(a=i.match(RegExp(Lr,"g")))==null||a.forEach(s=>{if(s==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let n=this.symbolToInfo.get(s);if(n===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(n.dimValue)}}),this.rhs=this.processTerm(i,!1,this.outputDims)}addSymbol(e,t,r){let i=this.symbolToInfo.get(e);if(i!==void 0){if(i.dimValue!==t&&i.count!==1)throw new Error("Dimension mismatch");i.count++,i.inputIndices.push(r)}else i={count:1,dimValue:t,inputIndices:[r]};this.symbolToInfo.set(e,i)}processTerm(e,t,r,i=-1){let a=r.length,s=!1,n=[],u=0;if(!e.match(RegExp(ea))&&!t&&e!=="")throw new Error("Invalid LHS term");let l=e.match(RegExp(Lr,"g")),p=new tl(i);return l==null||l.forEach((h,f)=>{if(h==="..."){if(s)throw new Error("Only one ellipsis is allowed per input term");s=!0;let g=a-l.length+1;if(g<0)throw new Error("Ellipsis out of bounds");if(n=r.slice(u,u+g),this.hasEllipsis){if(this.ellipsisDims.length!==n.length||this.ellipsisDims.toString()!==n.toString())throw new Error("Ellipsis dimensions mismatch")}else if(t)this.hasEllipsis=!0,this.ellipsisDims=n;else throw new Error("Ellipsis must be specified in the LHS");for(let y=0;y<n.length;y++){let _=String.fromCharCode(48+y);p.addSymbol(_,f+y),this.addSymbol(_,r[u++],i)}}else p.addSymbol(h,f+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(h,r[u++],i)}),p}},ta=e=>e+"_max",il=(e,t,r,i)=>{let a=e.map(p=>p.length).map((p,h)=>M(`input${h}`,t,p)),s=R.size(i),n=Q("output",t,i.length),u=[...r.symbolToInfo.keys()].filter(p=>!r.rhs.symbolToIndices.has(p)),l=p=>{let h=[],f="var prod = 1.0;",g="var sum = 0.0;",y="sum += prod;",_=[],b=[],k=[],v=[],$=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((S,E)=>{var C;if(r.rhs.symbolToIndices.has(E)){let A=(C=r.rhs.symbolToIndices.get(E))==null?void 0:C[0];A!==void 0&&r.lhs.forEach((w,O)=>{if(S.inputIndices.includes(O)){let D=w.symbolToIndices.get(E);if(D===void 0)throw new Error("Invalid symbol error");D.forEach(L=>{h.push(`${a[O].indicesSet(`input${O}Indices`,L,n.indicesGet("outputIndices",A))}`)})}})}else r.lhs.forEach((A,w)=>{if(S.inputIndices.includes(w)){let O=A.symbolToIndices.get(E);if(O===void 0)throw new Error("Invalid symbol error");O.forEach(D=>{_.push(`${a[w].indicesSet(`input${w}Indices`,D,`${E}`)}`)}),v.push(`prod *= ${a[w].getByIndices(`input${w}Indices`)};`)}}),b.push(`for(var ${E}: u32 = 0; ${E} < uniforms.${ta(E)}; ${E}++) {`),k.push("}")});let I=$?[...h,`let sum = ${a.map((S,E)=>S.getByIndices(`input${E}Indices`)).join(" * ")};`]:[...h,g,...b,..._,f,...v,y,...k];return`
            ${p.registerUniforms(u.map(S=>({name:`${ta(S)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...a,n)}
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let p=u.filter(f=>r.symbolToInfo.has(f)).map(f=>{var g;return{type:12,data:((g=r.symbolToInfo.get(f))==null?void 0:g.dimValue)||0}});p.push({type:12,data:s});let h=e.map((f,g)=>[...ee(f)]).reduce((f,g)=>f.concat(g),p);return h.push(...ee(i)),{outputs:[{dims:i,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:h}},getShaderSource:l}},oh=(e,t)=>{let r=new rl(e.inputs,t.equation),i=r.outputDims,a=e.inputs.map((s,n)=>s.dims);e.compute(il(a,e.inputs[0].dataType,r,i))},uh=e=>{let t=e.equation.replace(/\s+/g,"");return fe({equation:t})}}),al,ra,nl,sl,lh,z0=P(()=>{te(),ie(),ae(),al=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),i=r.length<t.length?0:r.length-t.length,a=t.length<r.length?0:t.length-r.length;for(;i<r.length&&a<t.length;++i,++a)if(r[i]!==t[a]&&r[i]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},ra=(e,t)=>{let r=e.length-t.length,i=[];for(let a=0;a<r;++a)i.push(e[a]);for(let a=0;a<t.length;++a)i.push(t[a]===1?e[a+r]:t[a]);return i},nl=(e,t)=>e.length>t.length?ra(e,t):ra(t,e),sl=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),i=nl(t,r),a=e[0].dataType,s=a===9||R.size(t)===1,n=a===9||t.length>0&&t[t.length-1]%4===0?4:1,u=s||i.length>0&&i[i.length-1]%4===0?4:1,l=Math.ceil(R.size(i)/u),p=f=>{let g=M("input",a,t.length,n),y=Q("output",a,i.length,u),_;if(a===9){let b=(k,v,$="")=>`
    ...
    ${_}`},h=[{type:12,data:l},...ee(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${n}${u}`,inputDependencies:["rank"]},getShaderSource:p,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:h})}},lh=e=>{al(e.inputs),e.compute(sl(e.inputs),{inputs:[0]})}}),ol,dh,C0=P(()=>{te(),ie(),ae(),en(),ol=e=>{let t=e[0].dataType,r=R.size(e[0].dims),i=R.size(e[1].dims),a=i%4===0,s=n=>{let u=M("x",t,[1],4),l=M("bias",t,[1],4),p=Q("y",t,[1],4),h=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=y=>`
    ...
    ${n.mainStart(Kt)}
      ...
      ${g.mainStart()}
        ...
        ${v}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},ph=e=>fe({axis:e.axis}),ch=(e,t)=>{let r=e.inputs;ul(r),e.compute(ll(e.inputs,t))}}),dl,hh,fh,O0=P(()=>{te(),ie(),ae(),dl=(e,t,r,i,a,s,n,u,l)=>{let p=[{type:12,data:s},{type:12,data:i},{type:12,data:a},{type:12,data:r},{type:12,data:n},{type:12,data:u},{type:12,data:l}],h=[s];p.push(...ee(t.dims,h));let f=g=>{let y=M("indices_data",t.dataType,t.dims.length),_=Q("input_slice_offsets_data",12,1,1),b=[y,_],k=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:a.length},{name:"sizes_from_slice_dims_data",type:"u32",length:r.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((y,_)=>_!==1).map(y=>y.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(y,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:p}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:f}),getShaderSource:g}},mh=(e,t)=>{let r=e.inputs;pl(r,t),e.compute(cl(e.inputs,t))},gh=e=>fe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),hl,fl,yh,_h,B0=P(()=>{te(),ie(),Se(),ae(),hl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return f?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:p*h},programUniforms:y}),getShaderSource:k}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:y}),getShaderSource:b}},bh=e=>{let t=e.transA,r=e.transB,i=e.alpha,a=e.beta;return{transA:t,transB:r,alpha:i,beta:a,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},wh=(e,t)=>{ml(e.inputs),e.compute(gl(e.inputs,t))}}),nt,lt,It,Et,yl,_l,bl,wl,$l,vl,xl,Sl,$h,vh,M0=P(()=>{te(),ie(),Se(),ae(),[nt,lt,It,Et]=[0,1,2,3],yl=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},_l=`
...
`,xl=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${r.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,Sl=(e,t)=>{let r=M("x",e[0].dataType,e[0].dims.length),i=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],a=M("grid",e[1].dataType,i.length,2),s=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(s=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[nt,lt,It,Et]=[0,3,1,2]);let n=Q("output",e[0].dataType,s.length),u=r.type.value,l=R.size(s),p=[{type:12,data:l},...ee(e[0].dims,i,s)],h=f=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:p}),getShaderSource:h},{inputs:[t,r],outputs:[-1]})[0]},fr=(e,t,r,i,a,s,n,u)=>{let l=s;if(n&&R.size(n.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Tl(e,s,n,t,i,r*a,u),l=l.reshape([t,i,r,a]),r===1||i===1?l:e.compute(Ve(l,ia.perm),{inputs:[l],outputs:[-1]})[0]}else return s.dims.length===3&&(l=s.reshape([t,i,r,a])),r===1||i===1?l:e.compute(Ve(l,ia.perm),{inputs:[l],outputs:[-1]})[0]},Sh=(e,t)=>{let r=kl(e.inputs,t),i=e.inputs[0],a=Re(e.inputs,1),s=Re(e.inputs,2),n=Re(e.inputs,3),u=Re(e.inputs,4),l=Re(e.inputs,5),p=Re(e.inputs,6),h=Re(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if((a==null?void 0:a.dims.length)===5)throw new Error("Packed KV is not implemented");let f=a&&s&&a.dims.length===4&&s.dims.length===4,g=fr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,n,0);if(f)return _r(e,g,a,s,u,void 0,p,h,l,r);if(!a||!s)throw new Error("key and value must be provided");let y=fr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,a,n,r.hiddenSize),_=fr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,n,2*r.hiddenSize);_r(e,g,y,_,u,void 0,p,h,l,r)}}),Il,El,zl,Cl,Na,Th,Ih,Eh=P(()=>{te(),ie(),Se(),ae(),Il=e=>{if(!e||e.length<1)throw new Error("too few inputs")},El=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),fe({numOutputs:i,axis:t.axis,splitSizes:r})},zl=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:p,dispatchGroup:{x:Math.ceil(i/64)},programUniforms:g})}},Th=(e,t)=>{Il(e.inputs);let r=e.inputs.length===1?t:El(e.inputs,t);e.compute(Na(e.inputs,r),{inputs:[0]})},Ih=e=>{let t=e.axis,r=e.splitSizes,i=e.numOutputs<0?r.length:e.numOutputs;if(i!==r.length)throw new Error("numOutputs and splitSizes length must be equal");return fe({axis:t,numOutputs:i,splitSizes:r})}}),Al,ti,zh,Ch=P(()=>{te(),ie(),Se(),ae(),Al=(e,t)=>{let[r,i,a,s]=e,{numHeads:n,rotaryEmbeddingDim:u}=t;if(r.dims.length!==3&&r.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${r.dims.length}`);if(!R.areEqual(i.dims,[])&&!R.areEqual(i.dims,[1])&&i.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${i.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(s.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${s.dims.length}`);if(!R.areEqual(a.dims,s.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(u>0&&n===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let l=r.dims[0],p=r.dims[r.dims.length-2],h=a.dims[0],f=R.sizeFromDimension(r.dims,1)/p,g=u===0?a.dims[1]*2:f/n;if(u>g)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(i.dims.length===2){if(l!==i.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${i.dims[0]}`);if(p!==i.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${i.dims[1]}`)}if(p>h)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported");if(g/2!==a.dims[1]&&u/2!==a.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${a.dims[1]}`)},ti=(e,t)=>{let{interleaved:r,numHeads:i,rotaryEmbeddingDim:a,scale:s}=t,n=e[0].dims[0],u=R.sizeFromDimension(e[0].dims,1),l=e[0].dims[e[0].dims.length-2],p=u/l,h=e[2].dims[1],f=a===0?h*2:p/i,g=new Array(n,l,p/f,f-h),y=R.computeStrides(g),_=[{type:1,data:s},{type:12,data:g},{type:12,data:y},...e[0].dims.length===3?new Array({type:12,data:[u,p,f,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[u,f,l*f,1]}):[],...ee(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],b=k=>{let v=M("input",e[0].dataType,e[0].dims.length),$=M("position_ids",e[1].dataType,e[1].dims.length),I=M("cos_cache",e[2].dataType,e[2].dims.length),S=M("sin_cache",e[3].dataType,e[3].dims.length),E=Q("output",e[0].dataType,e[0].dims.length);return k.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:g.length},{name:"global_strides",type:"u32",length:y.length},{name:"input_output_strides",type:"u32",length:y.length}]),`
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:s},getRunData:()=>({outputs:[{dims:n,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:p}},Ah=(e,t)=>{var S;let r=Ol(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((S=e.inputs[1])==null?void 0:S.dims.length)===5)throw new Error("Packed KV is not implemented");let i=e.inputs[0],a=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,s=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,n=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,u=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,l=e.inputs.length>4?e.inputs[5]:void 0,p=e.inputs.length>5?e.inputs[6]:void 0,h=r.kvNumHeads?r.kvNumHeads:r.numHeads,f=fe({axis:2,numOutputs:3,splitSizes:[r.numHeads*r.headSize,h*r.headSize,h*r.headSize]}),[g,y,_]=!a&&!s?e.compute(Na([i],f),{inputs:[i],outputs:[-1,-1,-1]}):[i,a,s],b,k;if(t.doRotary){let E=e.compute(Bl(r.batchSize,r.sequenceLength,l,p),{inputs:[l,p],outputs:[-1]})[0],C=e.inputs[7],A=e.inputs[8],w=fe({interleaved:t.rotaryInterleaved!==0,numHeads:r.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),O=[g,E,C,A],D=[-1];b=e.compute(ti(O,w),{inputs:O,outputs:D})[0],O.splice(0,1,y);let L=fe({interleaved:t.rotaryInterleaved!==0,numHeads:r.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});k=e.compute(ti(O,L),{inputs:O,outputs:D})[0]}let v=fr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,t.doRotary?b:g,void 0,0),$=aa(e,t.doRotary?k:y,r),I=aa(e,_,r);_r(e,v,$,I,void 0,void 0,n,u,void 0,r,l,p)}}),na,Nl,Ml,Oh,P0=P(()=>{te(),ie(),vt(),ae(),na=(e,t,r,i,a,s,n,u)=>{let l=xe(s),p=l===1?"f32":`vec${l}f`,h=l===1?"vec2f":`mat2x${l}f`,f=a*n,g=64;f===1&&(g=256);let y=[a,n,s/l],_=[a,n,2],b=["rank","type","type"],k=[];k.push(...ee(y,_));let v=$=>{let I=M("x",t.dataType,3,l),S=M("scale",r.dataType,r.dims),E=M("bias",i.dataType,i.dims),C=Q("output",1,3,2),A=[I,S,E,C];return`
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${p}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:[{type:12,data:h},...ee(g,y,g)]}),getShaderSource:b},{inputs:[t[0],f]})},Ml=(e,t,r)=>{let i=t[0].dims,a=i,s=i[0],n=i[i.length-1],u=R.sizeFromDimension(i,1)/n,l=xe(n),p=R.size(a)/l,h=[{type:12,data:u},{type:12,data:Math.floor(n/l)}],f=["type","type"],g=!1,y=[0,i.length-1];for(let v=0;v<i.length-2;v++)g=g||i[v+1]!==1,y.push(v+1);g=g&&i[i.length-1]!==1;let _=g?e.compute(Ve(e.inputs[0],y),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},(v,$)=>i[y[$]])),b=na(e,_,t[1],t[2],s,u,n,r.epsilon),k=v=>{let $=Ee(t[0].dataType),I=l===1?"vec2f":`mat${l}x2f`,S=A=>{let w=A===0?"x":"y",O=l===1?"f32":`vec${l}f`;switch(l){case 1:return`${$}(${O}(scale.${w}))`;case 2:return`vec2<${$}>(${O}(scale[0].${w}, scale[1].${w}))`;case 4:return`vec4<${$}>(${O}(scale[0].${w}, scale[1].${w}, scale[2].${w}, scale[3].${w}))`;default:throw new Error(`Not supported compoents ${l}`)}},E=M("input",t[0].dataType,t[0].dims,l),C=Q("output",t[0].dataType,a,l);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${l}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:a,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:k},{inputs:[t[0],b]})},Oh=(e,t)=>{t.format==="NHWC"?Ml(e,e.inputs,t):Nl(e,e.inputs,t)}}),Dl,Pl,Rh,U0=P(()=>{te(),ie(),ae(),Dl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Pl=(e,t,r)=>{let i=t.simplified,a=e[0].dims,s=e[1],n=!i&&e[2],u=a,l=R.normalizeAxis(t.axis,a.length),p=R.sizeToDimension(a,l),h=R.sizeFromDimension(a,l),f=R.size(s.dims),g=n?R.size(n.dims):0;if(f!==h||n&&g!==h)throw new Error(`Size of X.shape()[axis:] == ${h}.
  ...
  ${E.mainStart()}
    ...
    ${$?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},S=[{dims:u,dataType:e[0].dataType}];return v&&S.push({dims:y,dataType:1}),$&&S.push({dims:y,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${_};${r};${i}`,inputDependencies:b},getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(p/64)},programUniforms:k}),getShaderSource:I}},Rh=(e,t)=>{Dl(e.inputs),e.compute(Pl(e.inputs,t,e.outputCount))}}),Ul,Bh,q0=P(()=>{ie(),nn(),sn(),Ul=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Bh=e=>{Ul(e.inputs);let t=jt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],i=e.inputs[0].dims[e.inputs[0].dims.length-1];if(r<8&&i<8)e.compute(an(e.inputs,{activation:""},t));else{let a=t[t.length-2],s=R.size(e.inputs[0].dims.slice(0,-2)),n=R.size(e.inputs[1].dims.slice(0,-2));if(s!==1&&a===1&&n===1){let u=e.inputs[0].reshape([1,s,i]),l=e.inputs[1].reshape([1,i,r]),p=[1,s,r],h=[u,l];e.compute(ei(h,{activation:""},t,p),{inputs:h})}else e.compute(ei(e.inputs,{activation:""},t))}}}),ql,Ll,Wl,Nh,Mh,L0=P(()=>{te(),ie(),Se(),ae(),ql=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],i=r.dims.length;if(r.dims[i-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let a=Math.floor((t.k+t.blockSize-1)/t.blockSize),s=t.blockSize/8*t.bits,n=e[1];if(!R.areEqual(n.dims,[t.n,a,s]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(R.size(u)!==t.n*a)throw new Error("scales input size error.");if(e.length===4){let l=e[3].dims,p=t.n*(t.bits===8?a:Math.floor((a*t.bits+7)/8));if(R.size(l)!==p)throw new Error("zeroPoints input size error.")}},Ll=(e,t)=>{let r=e[0].dims,i=r.length,a=r[i-2],s=t.k,n=t.n,u=r.slice(0,i-2),l=R.size(u),p=e[1].dims[2]/4,h=e[0].dataType,f=xe(t.k),g=xe(p),y=xe(n),_=u.concat([a,n]),b=a>1&&n/y%2===0?2:1,k=R.size(_)/y/b,v=64,$=[],I=[l,a,s/f],S=R.convertShape(e[1].dims).slice();S.splice(-1,1,p/g),$.push(...ee(I)),$.push(...ee(S)),$.push(...ee(e[2].dims)),e.length===4&&$.push(...ee(R.convertShape(e[3].dims)));let E=[l,a,n/y];$.push(...ee(E));let C=A=>{let w=I.length,O=M("a",e[0].dataType,w,f),D=M("b",12,S.length,g),L=M("scales",e[2].dataType,e[2].dims.length),G=[O,D,L],j=e.length===4?M("zero_points",12,e[3].dims.length):void 0;j&&G.push(j);let B=E.length,H=Q("output",e[0].dataType,B,y),Z=Ee(e[0].dataType),J=(()=>{switch(f){case 1:return`array<${Z}, 8>`;case 2:return`mat4x2<${Z}>`;case 4:return`mat2x4<${Z}>`;default:throw new Error(`${f}-component is not supported.`)}})(),he=Math.floor(32/t.bits),V=Math.floor(he/8),ue=()=>{let X="";for(let q=0;q<V;q++){let me=q*t.bits*4,Ge=me+t.bits;X+=`
          // reuse a data (pass ${q})
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${f};${g};${k};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:y,dataType:h}],dispatchGroup:{x:E},programUniforms:C}),getShaderSource:D}},Nh=(e,t)=>{ql(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Wl(e.inputs,t)):e.compute(Ll(e.inputs,t))},Mh=e=>fe(e)}),Vl,Gl,Hl,Fl,jl,Kl,Zl,Xl,Dh,W0=P(()=>{te(),ie(),ae(),Vl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Gl=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
      ...
      `},Hl=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
          ...
          `},jl=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
            ...
            `;return`
              ...
              ${i}
              value = x[offset];
          `},Kl=(e,t,r)=>{switch(r.mode){case 0:return Gl(e,t,r.pads.length);case 1:return Hl(e,t,r.pads.length);case 2:return Fl(e,t,r.pads.length);case 3:return jl(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Zl=(e,t)=>{let r=R.padShape(e[0].dims.slice(),t.pads),i=e[0].dims,a=R.size(r),s=[{type:12,data:a},{type:6,data:t.pads}],n=e.length>=3&&e[2].data;t.mode===0&&s.push({type:n?e[2].dataType:1,data:t.value}),s.push(...ee(e[0].dims,r));let u=["rank"],l=p=>{let h=Q("output",e[0].dataType,r.length),f=M("x",e[0].dataType,i.length),g=f.type.value,y=Kl(h,i.length,t),_=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&_.push({name:"constant_value",type:n?g:"f32"}),`
            ...
            ${y}
            output[global_idx] = value;
        }`};return{name:"Pad",shaderCache:{hint:`${t.mode}${n}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(R.size(r)/64)},programUniforms:s}),getShaderSource:l}},Xl=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),i=e.length>=3&&e[2].data?e[2].dataType===10?e[2].getUint16Array()[0]:e[2].getFloat32Array()[0]:0,a=e[0].dims.length,s=new Int32Array(2*a).fill(0);if(e.length>=4){let u=e[3].getBigInt64Array();for(let l=0;l<u.length;l++)s[Number(u[l])]=Number(r[l]),s[Number(u[l])+a]=Number(r[l+u.length])}else r.forEach((u,l)=>s[Number(l)]=Number(u));let n=[];return s.forEach(u=>n.push(u)),{mode:t.mode,value:i,pads:n}}else return t},Dh=(e,t)=>{Vl(e.inputs);let r=Xl(e.inputs,t);e.compute(Zl(e.inputs,r),{inputs:[0]})}}),or,sa,oa,ua,la,Ql,Yl,da,pa,Ph,Uh,ca,qh,Lh,ha,Wh,Vh,Gh,Hh,V0=P(()=>{Fe(),te(),ie(),ae(),or=e=>{if(be.webgpu.validateInputContent&&(!e||e.length!==1))throw new Error("Pool ops requires 1 input.")},sa=(e,t,r)=>{let i=t.format==="NHWC",a=e.dims.slice();i&&a.splice(1,0,a.pop());let s=Object.hasOwnProperty.call(t,"dilations"),n=t.kernelShape.slice(),u=t.strides.slice(),l=s?t.dilations.slice():[],p=t.pads.slice();Yr.adjustPoolAttributes(r,a,n,u,l,p);let h=Yr.computePoolOutputShape(r,a,u,l,n,p,t.autoPad),f=Object.assign({},t);s?Object.assign(f,{kernelShape:n,strides:u,pads:p,dilations:l,cacheKey:t.cacheKey}):Object.assign(f,{kernelShape:n,strides:u,pads:p,cacheKey:t.cacheKey});let g=h.slice();return g.push(g.splice(1,1)[0]),[f,i?g:h]},oa=(e,t)=>{let r=t.format==="NHWC",i=R.size(e),a=R.size(t.kernelShape),s=[{type:12,data:i},{type:12,data:a}],n=[{name:"outputSize",type:"u32"},{name:"kernelSize",type:"u32"}];if(t.kernelShape.length<=2){let u=t.kernelShape[t.kernelShape.length-1],l=t.strides[t.strides.length-1],p=t.pads[t.pads.length/2-1],h=t.pads[t.pads.length-1],f=!!(p+h);s.push({type:12,data:u},{type:12,data:l},{type:12,data:p},{type:12,data:h}),n.push({name:"kw",type:"u32"},{name:"sw",type:"u32"},{name:"pwStart",type:"u32"},{name:"pwEnd",type:"u32"});let g=!1;if(t.kernelShape.length===2){let y=t.kernelShape[t.kernelShape.length-2],_=t.strides[t.strides.length-2],b=t.pads[t.pads.length/2-2],k=t.pads[t.pads.length-2];g=!!(b+k),s.push({type:12,data:y},{type:12,data:_},{type:12,data:b},{type:12,data:k}),n.push({name:"kh",type:"u32"},{name:"sh",type:"u32"},{name:"phStart",type:"u32"},{name:"phEnd",type:"u32"})}return[s,n,!0,f,g]}else{if(r)throw new Error("Pooling with kernelShape.length > 2 is not supported for NHWC format.");let u=R.computeStrides(t.kernelShape);s.push({type:12,data:u},{type:12,data:t.pads},{type:12,data:t.strides}),n.push({name:"kernelStrides",type:"u32",length:u.length},{name:"pads",type:"u32",length:t.pads.length},{name:"strides",type:"u32",length:t.strides.length});let l=t.pads.reduce((p,h)=>p+h);return[s,n,!!l,!1,!1]}},ua=(e,t,r,i,a,s,n,u,l,p,h,f)=>{let g=a.format==="NHWC",y=t.type.value,_=Q("output",t.type.tensor,i);if(a.kernelShape.length<=2){let b="",k="",v="",$=r-(g?2:1);if(h?b=`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},la=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Ql=e=>`${la(e)};${e.countIncludePad}`,Yl=e=>`${la(e)};${e.storageOrder};${e.dilations}`,da=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),pa=(e,t,r,i)=>{let[a,s]=sa(t,i,r),n=M("x",t.dataType,t.dims.length),u=n.type.value,l="value += x_val;",p="";a.countIncludePad?p+=`value /= ${u}(uniforms.kernelSize);`:p+=`value /= ${u}(i32(uniforms.kernelSize) - pad);`;let[h,f,g,y,_]=oa(s,a);h.push(...ee(t.dims,s));let b=["rank"];return{name:e,shaderCache:{hint:`${i.cacheKey};${g};${y};${_}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(R.size(s)/64)},programUniforms:h}),getShaderSource:k=>ua(k,n,t.dims.length,s.length,a,l,p,0,f,g,y,_)}},Ph=e=>{let t=e.count_include_pad!==0,r=da(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let i={countIncludePad:t,...r,cacheKey:""};return{...i,cacheKey:Ql(i)}},Uh=(e,t)=>{or(e.inputs),e.compute(pa("AveragePool",e.inputs[0],!1,t))},ca={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},qh=e=>{let t=e.format;return{format:t,...ca,cacheKey:t}},Lh=(e,t)=>{or(e.inputs),e.compute(pa("GlobalAveragePool",e.inputs[0],!0,t))},ha=(e,t,r,i)=>{let[a,s]=sa(t,i,r),n=`
      value = max(x_val, value);
    `,u="",l=M("x",t.dataType,t.dims.length),p=["rank"],[h,f,g,y,_]=oa(s,a);return h.push(...ee(t.dims,s)),{name:e,shaderCache:{hint:`${i.cacheKey};${g};${y};${_}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(R.size(s)/64)},programUniforms:h}),getShaderSource:b=>ua(b,l,t.dims.length,s.length,a,n,u,t.dataType===10?-65504:-1e5,f,g,y,_)}},Wh=(e,t)=>{or(e.inputs),e.compute(ha("MaxPool",e.inputs[0],!1,t))},Vh=e=>{let t=e.storage_order,r=e.dilations,i=da(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:Yl(a)}},Gh=e=>{let t=e.format;return{format:t,...ca,cacheKey:t}},Hh=(e,t)=>{or(e.inputs),e.compute(ha("GlobalMaxPool",e.inputs[0],!0,t))}}),Jl,ed,Fh,jh,G0=P(()=>{te(),ie(),Se(),ae(),Jl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,s)=>s===t.axis||a===e[0].dims[s]).reduce((a,s)=>a&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},ed=(e,t)=>{let r=R.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,s=e[0].dims,n=e[1].dataType,u=R.size(s),l=i===3||i===2,p=l?[Math.ceil(R.size(e[0].dims)/4)]:e[0].dims,h=e[1].dims,f=e.length>2?e[2]:void 0,g=f?l?[Math.ceil(R.size(f.dims)/4)]:f.dims:void 0,y=h.length===0||h.length===1&&h[0]===1,_=y===!1&&h.length===1,b=xe(u),k=y&&(!l||b===4),v=k?b:1,$=k&&!l?b:1,I=M("input",l?12:i,p.length,$),S=M("scale",n,h.length),E=f?M("zero_point",l?12:i,g.length):void 0,C=Q("output",n,s.length,v),A=[I,S];E&&A.push(E);let w=[p,h];f&&w.push(g);let O=[{type:12,data:u/v},{type:12,data:r},{type:12,data:t.blockSize},...ee(...w,s)],D=L=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:E?["rank","rank","rank"]:["rank","rank"]},getShaderSource:D,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:O})}},Fh=(e,t)=>{Jl(e.inputs,t),e.compute(ed(e.inputs,t))},jh=e=>fe({axis:e.axis,blockSize:e.blockSize})}),td,rd,Kh,H0=P(()=>{Fe(),te(),ae(),td=(e,t,r)=>{let i=e===t,a=e<t&&r<0,s=e>t&&r>0;if(i||a||s)throw new Error("Range these inputs' contents are invalid.")},rd=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),s=[a],n=a,u=[{type:12,data:n},{type:i,data:e},{type:i,data:r},...ee(s)],l=p=>{let h=Q("output",i,s.length),f=h.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${p.registerUniforms(g).declareVariables(h)}
        ${p.mainStart()}
        ${p.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:l,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:u})}},Kh=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),be.webgpu.validateInputContent&&td(t,r,i),e.compute(rd(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),id,ad,Zh,Xh,F0=P(()=>{te(),ie(),Se(),ae(),id=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let a=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,s=`;
              ...
              ${a}bitcast<${i}>(oldValue) + (${r})${s}`;case"max":return i==="i32"||i==="u32"?`atomicMax(&${t}, bitcast<${i}>(${r}));`:`
                ${a}max(bitcast<f32>(oldValue), (${r}))${s}`;case"min":return i==="i32"||i==="u32"?`atomicMin(&${t}, bitcast<${i}>(${r}));`:`${a}min(bitcast<${i}>(oldValue), (${r}))${s}`;case"mul":return`${a}(bitcast<${i}>(oldValue) * (${r}))${s}`;default:throw new Error(`Reduction ${e} is not supported.`)}},ad=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,s=1,n=Math.ceil(R.sizeToDimension(i,i.length-1)/s),u=i[i.length-1],l=R.sizeFromDimension(r,u),p=[{type:12,data:n},{type:12,data:u},{type:12,data:l},...ee(e[1].dims,e[2].dims,a)],h=f=>{let g=M("indices",e[1].dataType,e[1].dims.length),y=M("updates",e[2].dataType,e[2].dims.length,s),_=t.reduction!=="none"&&t.reduction!==""?Sp("output",e[0].dataType,a.length):Q("output",e[0].dataType,a.length,s);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${id(t.reduction,"output[data_offset + i]","value",_.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:h}},Zh=e=>fe({reduction:e.reduction}),Xh=(e,t)=>{e.compute(ad(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),nd,sd,od,fa,ud,ld,dd,pd,cd,hd,fd,md,ma,gd,yd,_d,bd,wd,Qh,Yh,j0=P(()=>{te(),ie(),Se(),ae(),nd=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},sd=(e,t,r)=>{t.every(a=>a>=0&&a<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let i=new Array(r).fill(1);return t.forEach((a,s)=>i[a]=e[s]),i},od=(e,t,r,i,a,s)=>{let[n,u,l]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],p=e[0].dims.length;if(n>0&&e.length>n&&e[n].dims.length>0)e[n].getFloat32Array().forEach(h=>s.push(h));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(h=>i.push(h)),i.length!==0&&i.length!==p&&r>=18&&i.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");nd(i,t),t.axes.length>0&&sd(i,t.axes,p).forEach((h,f)=>i[f]=h)}if(l>0&&e.length>l&&e[l].dims.length===1&&e[l].dims[0]>0&&(e[l].getBigInt64Array().forEach(h=>a.push(Number(h))),a.length!==0&&a.length!==p&&r>=18&&a.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(i.length!==0&&i.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(a.length!==0&&a.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof i<"u"&&typeof a<"u"&&i.length>0&&a.length>p)throw new Error("Resize requires only of scales or sizes to be specified")},fa=(e,t,r,i)=>`
...
`:"",gd=(e,t,r,i,a)=>{let[s,n,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],p=e.type.value;return`
    ...
    }`},yd=(e,t,r,i,a,s,n,u,l,p)=>{let h=r.length===2,[f,g]=h?[0,1]:[2,3],y=e.type.value,_=b=>{let k=b===f?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${y} {
    ...
    `},_d=(e,t,r,i,a)=>{let[s,n,u,l,p]=r.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],h=e.type.value;return`
    ...
    }`},bd=(e,t,r,i,a,s)=>{let n=e.dims,u=dd(s,t.axes,n.length),l=pd(n,i,a,t.axes),p=i.slice();i.length===0&&(p=n.map(($,I)=>$===0?1:l[I]/$),t.keepAspectRatioPolicy!=="stretch"&&(l=cd(n,p,t)));let h=Q("output",e.dataType,l.length),f=M("input",e.dataType,n.length),g=R.size(l),y=n.length===l.length&&n.every(($,I)=>$===l[I]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=f.type.value,v=$=>`
      ${y?"":`
      ${ud(t.coordinateTransformMode,k)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${md(f,n)};
              ${ld(t.nearestMode,r,k)};
              ${fd(f,h,n,l,p.length,u.length,_)};
              `;case"linear":return`
              ${hd(h,n,l,p.length,u.length)};
              ${(()=>{if(n.length===2||n.length===4)return`${gd(f,h,n,_,b)}`;if(n.length===3||n.length===5)return`${_d(f,h,n,_,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(n.length===2||n.length===4)return`${yd(f,h,n,l,p,u,t.cubicCoeffA,_,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${r}|${p.length>0?t.mode==="cubic"?p:p.length:""}|${a.length>0?a:""}|${u.length>0?u:""}|${y}|${t.mode==="nearest"?n.length:n}`,inputDependencies:["rank"]},getShaderSource:v,getRunData:()=>({outputs:[{dims:l,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:[{type:12,data:g},{type:1,data:p},{type:1,data:u},...ee(n,l)]})}},wd=e=>{let t=e.customDataBuffer;return new Uint32Array(t.buffer,t.byteOffset,1)[0]},Qh=(e,t)=>{let r=[],i=[],a=[],s=wd(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");od(e.inputs,t,s,r,i,a),e.compute(bd(e.inputs[0],t,s,r,i,a),{inputs:[0]})},Yh=e=>{let t=e.antialias,r=e.axes,i=e.coordinateTransformMode,a=e.cubicCoeffA,s=e.excludeOutside!==0,n=e.extrapolationValue,u=e.keepAspectRatioPolicy,l=e.mode,p=e.nearestMode===""?"simple":e.nearestMode;return fe({antialias:t,axes:r,coordinateTransformMode:i,cubicCoeffA:a,excludeOutside:s,extrapolationValue:n,keepAspectRatioPolicy:u,mode:l,nearestMode:p})}}),$d,vd,Jh,K0=P(()=>{te(),ie(),ae(),$d=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],i=e[2];if(t.dataType!==r.dataType||t.dataType!==i.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let a=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==a)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(i.dims.length!==1)throw new Error("Gamma must be 1D");if(i.dims[i.dims.length-1]!==a)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let n=e[3];if(n.dims.length!==1)throw new Error("Beta must be 1D");if(n.dims[n.dims.length-1]!==a)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let n=e[4];if(n.dims.length!==1)throw new Error("Bias must be 1D");if(n.dims[n.dims.length-1]!==a)throw new Error("Bias must have the same hidden size as input")}},vd=(e,t,r,i)=>{let a=t.simplified,s=e[0].dims,n=R.size(s),u=s,l=n,p=s.slice(-1)[0],h=i?s.slice(0,-1).concat(1):[],f=!a&&e.length>3,g=e.length>4,y=i&&r>1,_=i&&r>2,b=r>3,k=64,v=xe(p),$=[{type:12,data:l},{type:12,data:v},{type:12,data:p},{type:1,data:t.epsilon}],I=E=>{let C=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],A=[M("x",e[0].dataType,e[0].dims,v),M("skip",e[1].dataType,e[1].dims,v),M("gamma",e[2].dataType,e[2].dims,v)];f&&A.push(M("beta",e[3].dataType,e[3].dims,v)),g&&A.push(M("bias",e[4].dataType,e[4].dims,v)),A.push(Q("output",e[0].dataType,u,v)),y&&A.push(Q("mean_output",1,h)),_&&A.push(Q("inv_std_output",1,h)),b&&A.push(Q("input_skip_bias_sum",e[0].dataType,u,v));let w=Ee(e[0].dataType),O=Ee(1,v);return`
      ...
      }`},S=[{dims:u,dataType:e[0].dataType}];return r>1&&S.push({dims:h,dataType:1}),r>2&&S.push({dims:h,dataType:1}),r>3&&S.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${y};${_};${b}`,inputDependencies:e.map((E,C)=>"type")},getShaderSource:I,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(l/p)},programUniforms:$})}},Jh=(e,t)=>{$d(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(vd(e.inputs,t,e.outputCount,!1),{outputs:r})}}),xd,ur,Sd,ga,kd,Td,ef,tf,Z0=P(()=>{te(),ie(),Se(),ae(),xd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},ur=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Sd=(e,t)=>{if(e.length>1){let r=ur(e,1),i=ur(e,2),a=ur(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),fe({starts:r,ends:i,axes:a})}else return t},ga=(e,t,r,i,a)=>{let s=e;return e<0&&(s+=r[i[t]]),a[t]<0?Math.max(0,Math.min(s,r[i[t]]-1)):Math.max(0,Math.min(s,r[i[t]]))},kd=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${n.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:k,getRunData:()=>({outputs:[h],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:b})}},ef=(e,t)=>{xd(e.inputs,t);let r=Sd(e.inputs,t);e.compute(Td(e.inputs,r),{inputs:[0]})},tf=e=>{let t=e.starts,r=e.ends,i=e.axes;return fe({starts:t,ends:r,axes:i})}}),Id,Ed,rf,af,X0=P(()=>{te(),ie(),Se(),vt(),ae(),Id=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Ed=(e,t)=>{let r=e.inputs[0],i=r.dims,a=R.size(i),s=i.length,n=R.normalizeAxis(t.axis,s),u=n<i.length-1,l,p=[];u?(p=Array.from({length:s},(A,w)=>w),p[n]=s-1,p[s-1]=n,l=e.compute(Ve(r,p),{inputs:[r],outputs:[-1]})[0]):l=r;let h=l.dims,f=h[s-1],g=a/f,y=xe(f),_=f/y,b=64;g===1&&(b=256);let k=(A,w)=>w===4?`max(max(${A}.x, ${A}.y), max(${A}.z, ${A}.w))`:w===2?`max(${A}.x, ${A}.y)`:w===3?`max(max(${A}.x, ${A}.y), ${A}.z)`:A,v=M("x",l.dataType,l.dims,y),$=Q("result",l.dataType,l.dims,y),I=v.type.value,S=Ee(l.dataType)==="f32"?`var threadMax = ${I}(-3.4028234663852886e+38f);`:`var threadMax = ${I}(-65504.0h);`,E=A=>`
 ...
 * limitations under the License.
 * =============================================================================
 */const sy=new Set([1,2,3,5,7]),oy={1:{ar:"دراجة",en:"bicycle"},2:{ar:"سيارة",en:"car"},3:{ar:"دراجة نارية",en:"motorcycle"},5:{ar:"حافلة",en:"bus"},7:{ar:"شاحنة",en:"truck"}},Ae=640,uy=.32,ly=.45;let gr=null,Pa="wasm";function dy(){return Pa}async function py(e){if(gr)return;const t=`${e}models/yolo11n.onnx`;be.wasm.numThreads=1;try{be.wasm.wasmPaths={wasm:`${e}ort/ort-wasm-simd-threaded.jsep.wasm`},gr=await Zr.create(t,{executionProviders:["webgpu"]}),Pa="webgpu"}catch{be.wasm.wasmPaths={wasm:`${e}ort/ort-wasm-simd-threaded.wasm`},gr=await Zr.create(t,{executionProviders:["wasm"]}),Pa="wasm"}}const Hr=typeof document<"u"?document.createElement("canvas"):null;async function cy(e){if(!gr||!Hr)return[];const t=e.videoWidth,r=e.videoHeight;if(!t||!r)return[];Hr.width=Ae,Hr.height=Ae;const i=Hr.getContext("2d",{willReadFrequently:!0}),a=Math.min(Ae/t,Ae/r),s=Math.round(t*a),n=Math.round(r*a),u=(Ae-s)/2,l=(Ae-n)/2;i.fillStyle="#727272",i.fillRect(0,0,Ae,Ae),i.drawImage(e,u,l,s,n);const{data:p}=i.getImageData(0,0,Ae,Ae),h=new Float32Array(3*Ae*Ae),f=Ae*Ae;for(let v=0;v<f;v++)h[v]=p[v*4]/255,h[v+f]=p[v*4+1]/255,h[v+2*f]=p[v*4+2]/255;const g=new et("float32",h,[1,3,Ae,Ae]),_=(await gr.run({images:g})).output0.data,b=8400,k=[];for(let v=0;v<b;v++){let $=0,I=-1;for(let w=0;w<80;w++){const O=_[(4+w)*b+v];O>$&&($=O,I=w)}if($<uy||!sy.has(I))continue;const S=_[v],E=_[b+v],C=_[2*b+v],A=_[3*b+v];k.push({x:(S-C/2-u)/a,y:(E-A/2-l)/a,w:C/a,h:A/a,score:$,classId:I})}return hy(k)}function Tf(e,t){const r=Math.max(e.x,t.x),i=Math.max(e.y,t.y),a=Math.min(e.x+e.w,t.x+t.w),s=Math.min(e.y+e.h,t.y+t.h),n=Math.max(0,a-r)*Math.max(0,s-i);return n/(e.w*e.h+t.w*t.h-n||1)}function hy(e){const t=[...e].sort((i,a)=>a.score-i.score),r=[];for(const i of t)r.every(a=>Tf(a,i)<ly)&&r.push(i);return r}function fy(e){let t=1,r=[];for(const i of e){for(const a of i.boxes){let s=null,n=.25;for(const u of r){const l=Tf(a,u);l>n&&(n=l,s=u)}a.trackId=(s==null?void 0:s.trackId)??t++}r=i.boxes}return e}function my(e,t,r){const i=t*r,a=new Map;let s=0,n=0;const u=new Set;for(const l of e)for(const p of l.boxes){if(p.trackId===void 0)continue;const f=p.y+p.h/2>i?1:-1,g=a.get(p.trackId);g!==void 0&&g!==f&&!u.has(p.trackId)&&(u.add(p.trackId),f===1?s+=1:n+=1),a.set(p.trackId,f)}return{down:s,up:n,total:s+n}}const gy="_screen_1368h_1",yy="_header_1368h_11",_y="_back_1368h_13",by="_title_1368h_19",wy="_subtitle_1368h_20",$y="_why_1368h_21",vy="_stage_1368h_23",xy="_video_1368h_31",Sy="_overlay_1368h_33",ky="_progressWrap_1368h_41",Ty="_progressBar_1368h_56",Iy="_progressPct_1368h_66",Ey="_controls_1368h_73",zy="_primary_1368h_80",Cy="_uploadBtn_1368h_86",Ay="_status_1368h_92",Oy="_error_1368h_93",Ry="_replayBadge_1368h_95",By="_stat_1368h_92",Ny="_provider_1368h_103",My="_linkBtn_1368h_106",Dy="_honesty_1368h_111",ke={screen:gy,header:yy,back:_y,title:by,subtitle:wy,why:$y,stage:vy,video:xy,overlay:Sy,progressWrap:ky,progressBar:Ty,progressPct:Iy,controls:Ey,primary:zy,uploadBtn:Cy,status:Ay,error:Oy,replayBadge:Ry,stat:By,provider:Ny,linkBtn:My,honesty:Dy},Wd=.55,Py=.18,Uy={ar:{title:"تحليل تقاطع بالفيديو",subtitle:"كشف مركبات داخل المتصفح بالكامل — لا يغادر الفيديو جهازك",why:"",loadingModel:"تحميل النموذج (~10MB أول مرة)…",analyze:"حلّل المقطع",analyzing:"جارٍ التحليل مرة واحدة…",replay:"إعادة تشغيل سلسة من الذاكرة",upload:"ارفع مقطعاً آخر",counted:"مركبات عبرت الخط",down:"باتجاه الكاميرا",up:"مبتعدة",tracks:"مسارات مرصودة",provider:"المعالجة",modelCard:"بطاقة النماذج",err:"تعذر تحميل النموذج — أعد المحاولة أو استخدم متصفح Chrome/Edge حديثاً",honesty:"نموذج YOLO11n عام (COCO) — لا نعلن دقة رقمية على مشاهد أردنية لأنها غير مقيسة؛ العدّ مصمم قرب الكاميرا حيث يكون الكشف موثوقاً."},en:{title:"Intersection video analysis",subtitle:"Fully in-browser vehicle detection — the video never leaves your device",why:"",loadingModel:"Loading the model (~10MB first time)…",analyze:"Analyze the clip",analyzing:"Analyzing once…",replay:"Smooth replay from cache",upload:"Upload another clip",counted:"Vehicles crossed the line",down:"Toward camera",up:"Away",tracks:"Tracks observed",provider:"Processing",modelCard:"Model Card",err:"Model failed to load — retry or use a recent Chrome/Edge",honesty:"Generic YOLO11n (COCO) — no numeric accuracy is claimed on Jordanian scenes as none was measured; counting is designed near-camera where detection is reliable."}};function Fy(){const{language:e}=Dg(),t=Pg(),r=Uy[e],i="/Program%20Files/Git/uqab-preview/",a=qe.useRef(null),s=qe.useRef(null),n=qe.useRef([]),u=qe.useRef({down:0,up:0,total:0}),l=qe.useRef(0),[p,h]=qe.useState("loading-model"),[f,g]=qe.useState(0),[y,_]=qe.useState(`${i}assets/detection/demo-intersection.mp4`),[b,k]=qe.useState(0);qe.useEffect(()=>{let S=!0;return py(i).then(()=>S&&h("ready")).catch(()=>S&&h("error")),()=>{S=!1}},[i]);const v=qe.useCallback(S=>{var B;const E=a.current,C=s.current;if(!E||!C)return;const A=E.videoWidth,w=E.videoHeight;C.width!==A&&(C.width=A,C.height=w);const O=C.getContext("2d");O.clearRect(0,0,A,w);const D=Wd*w;O.strokeStyle="rgba(217, 193, 155, 0.9)",O.setLineDash([14,10]),O.lineWidth=3,O.beginPath(),O.moveTo(0,D),O.lineTo(A,D),O.stroke(),O.setLineDash([]);for(const H of S){O.strokeStyle="#6FAE92",O.lineWidth=2.5,O.strokeRect(H.x,H.y,H.w,H.h);const Z=`${((B=oy[H.classId])==null?void 0:B[e])??""} #${H.trackId??""}`;O.font="600 15px Outfit, Tajawal, sans-serif";const J=O.measureText(Z).width+10;O.fillStyle="rgba(13, 23, 33, 0.82)",O.fillRect(H.x,Math.max(0,H.y-22),J,20),O.fillStyle="#D9C19B",O.fillText(Z,H.x+5,Math.max(14,H.y-7))}const L=u.current,G=`${r.counted}: ${L.total} · ${r.down} ${L.down} · ${r.up} ${L.up}`;O.font="700 17px Outfit, Tajawal, sans-serif";const j=O.measureText(G).width+18;O.fillStyle="rgba(13, 23, 33, 0.85)",O.fillRect(A-j-12,12,j,30),O.fillStyle="#E9EEF4",O.fillText(G,A-j-3,33)},[e,r]),$=qe.useCallback(async()=>{const S=a.current;if(!S)return;h("analyzing"),g(0),n.current=[],S.currentTime=0,S.muted=!0,await S.play();let E=-1,C=!1;await new Promise(D=>{const L=()=>{if(S.ended){D();return}const G=S.currentTime;!C&&G-E>=Py&&(C=!0,E=G,cy(S).then(j=>{n.current.push({t:G,boxes:j}),g(Math.min(99,Math.round(G/S.duration*100))),C=!1})),S.requestVideoFrameCallback(L)};S.requestVideoFrameCallback(L),S.onended=()=>D()}),fy(n.current),u.current=my(n.current,Wd,S.videoHeight);const A=new Set;for(const D of n.current)for(const L of D.boxes)L.trackId&&A.add(L.trackId);k(A.size),g(100),h("replay"),S.currentTime=0,await S.play();let w=0;const O=()=>{var G;const D=S.currentTime,L=n.current;for(;w<L.length-1&&L[w+1].t<=D;)w+=1;w>0&&D<L[w].t&&(w=0),v(((G=L[w])==null?void 0:G.boxes)??[]),l.current=requestAnimationFrame(O)};S.loop=!0,l.current=requestAnimationFrame(O)},[v]);qe.useEffect(()=>()=>cancelAnimationFrame(l.current),[]);const I=S=>{S&&(cancelAnimationFrame(l.current),y.startsWith("blob:")&&URL.revokeObjectURL(y),n.current=[],u.current={down:0,up:0,total:0},k(0),_(URL.createObjectURL(S)),h("ready"))};return ye.jsx(Ug,{activePath:"/ops/cameras",noBottomNav:!0,children:ye.jsxs("div",{className:ke.screen,children:[ye.jsxs("header",{className:ke.header,children:[ye.jsx("button",{type:"button",className:ke.back,onClick:()=>t(-1),children:"‹"}),ye.jsxs("div",{children:[ye.jsx("h1",{className:ke.title,children:r.title}),ye.jsx("p",{className:ke.subtitle,children:r.subtitle}),ye.jsx("p",{className:ke.why,children:e==="ar"?`لماذا؟ ${Vt[2].value} ${Vt[2].labelAr} (${Vt[2].sourceAr})`:`Why? ${Vt[2].value} ${Vt[2].labelEn} (${Vt[2].sourceEn})`})]})]}),ye.jsxs("div",{className:ke.stage,children:[ye.jsx("video",{ref:a,src:y,className:ke.video,playsInline:!0,preload:"auto"}),ye.jsx("canvas",{ref:s,className:ke.overlay}),p==="analyzing"&&ye.jsxs("div",{className:ke.progressWrap,children:[ye.jsx("span",{children:r.analyzing}),ye.jsx("div",{className:ke.progressBar,children:ye.jsx("i",{style:{width:`${f}%`}})}),ye.jsxs("b",{className:ke.progressPct,children:[f,"%"]})]})]}),ye.jsxs("div",{className:ke.controls,children:[p==="loading-model"&&ye.jsx("span",{className:ke.status,children:r.loadingModel}),p==="error"&&ye.jsx("span",{className:ke.error,children:r.err}),p==="ready"&&ye.jsxs("button",{type:"button",className:ke.primary,onClick:()=>void $(),children:["▶ ",r.analyze]}),p==="replay"&&ye.jsxs(ye.Fragment,{children:[ye.jsxs("span",{className:ke.replayBadge,children:["✓ ",r.replay]}),ye.jsxs("span",{className:ke.stat,children:[r.tracks,": ",ye.jsx("b",{children:b})]})]}),(p==="ready"||p==="replay")&&ye.jsxs("label",{className:ke.uploadBtn,children:[r.upload,ye.jsx("input",{type:"file",accept:"video/*",hidden:!0,onChange:S=>{var E;return I(((E=S.target.files)==null?void 0:E[0])??null)}})]}),ye.jsxs("span",{className:ke.provider,children:[r.provider,": ",ye.jsx("b",{children:p==="loading-model"?"…":dy()})]}),ye.jsx("button",{type:"button",className:ke.linkBtn,onClick:()=>t("/model-card"),children:r.modelCard})]}),ye.jsx("p",{className:ke.honesty,children:r.honesty})]})})}export{Fy as DetectionScreen};
